...
public class Test3 {
    ...
    public static int[] solution(String[] info, String[] query) {
        ...
        for (int i = 0; i < query.length; i++) {
            ...
            StringTokenizer st = new StringTokenizer(array[3]);
            ...
            for (int j = 0; j < info.length; j++) {
                ...
                int infoPoint = Integer.parseInt(info[j].split(" ")[4]);

                if (info[j].contains(lang) || lang.equals("-")) {
                    if (info[j].contains(end) || end.equals("-")) {
                        if (info[j].contains(grade) || grade.equals("-")) {
                            if (info[j].contains(soulfood) || soulfood.equals("-")) {
                                if (infoPoint >= point)
                                cnt++;
                            }
                        }
