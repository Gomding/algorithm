...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        ids[0] = "...!@BaT#*..y.abcdefghijklm";
        ids[1] = "z-+.^.";
        ids[2] = "=.=~!@#%^&*()=[]{}:?<>";
        ids[3] = "123_.def";
        ids[4] = "abcdefghijklmn.p";

        for (int i = 0; i < 5; i++){
            System.out.println(solution(ids[i]));
        }
    ...
    public static String solution(String new_id) {
        ...
        for (String chk : sc) {
            ...
            if (new_id.contains(chk)) {
                if (chk.equals("^") || chk.equals("?") || chk.equals("(") ||
                        chk.equals(")") || chk.equals("[") || chk.equals("]") || chk.equals("{") || chk.equals("}")) {
                    chk = "\\" + chk;
                }
                if (chk.equals("*") || chk.equals("+")) {
                    chk = "[" + chk + "]";
                }
                new_id = new_id.replaceAll(chk, "");
            }
        }
