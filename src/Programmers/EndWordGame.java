...
public class EndWordGame {
    ...
    public static void main(String[] args) {
        ...
        int[] result1 = solution(3, input1);
        int[] result2 = solution(5, input2);
        int[] result3 = solution(2, input3);
    ...
    public static int[] solution(int n, String[] words) {
        ...
        String[] usedWord = new String[size];
        usedWord[0] = words[0];
        ...
        for (int i = 1; i < size; i++) {
            ...
            if (beforeLast != nowFirst || Arrays.asList(usedWord).contains(nowWord)) {
                answer[0] = (i % n) + 1;
